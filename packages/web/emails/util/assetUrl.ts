 ...
 * run `pnpm dev:local-assets` instead of `pnpm dev`
 *
 * NOTE: This will cause the email linter to throw errors
 */

const ASSET_URL = (process.env.NEXT_PUBLIC_VERCEL_URL && `https://${process.env.NEXT_PUBLIC_VERCEL_URL}`) || process.env.MAILING_API_URL || "https://emails.mailing.run";
